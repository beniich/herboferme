...
import { Layers, Thermometer, Download, Navigation } from 'lucide-react';
        ...
        const onLocationFound = (e: L.LocationEvent) => {
            ...
            const userIcon = L.divIcon({
                html: `<div class="relative">
                    ...
                    <div class="relative size-4 bg-blue-600 border-2 border-white rounded-full shadow-lg"></div>
                </div>`,
                className: '',
                iconSize: [16, 16],
            });
        ...
        <div className="relative w-full h-full">
            ...
            <div className="absolute top-4 right-4 flex flex-col gap-2 z-[1000]">
                ...
                <button
                    ...
                    disabled={isLocating}
                    className={`bg-white dark:bg-slate-800 rounded-lg shadow-lg p-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors ${
                        isLocating ? 'animate-pulse opacity-50' : ''
                    }`}
                    title="Ma position"
                >
                    <Navigation className={`w-5 h-5 ${isLocating ? 'text-primary' : 'text-slate-600 dark:text-slate-400'}`} />
                </button>
            </div>
